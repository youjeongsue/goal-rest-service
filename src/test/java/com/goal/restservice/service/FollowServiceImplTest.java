...
class FollowServiceImplTest {
    ...
    public void 언팔로우(){
        ...
        followServiceImpl.unfollow(fan.getId(), UserDTO.builder().userName(notInterestingAnyMore.getUserName()).build());

        // then
        List<UserDTO> emptyFollowerList = followServiceImpl.getAllFollower(notInterestingAnyMore.getId());
