...
public class JwtServiceImpl implements JwtService {
    ...
    /**
     *  Create a JWT Token including
     *  [Header]
     *    typ : JWT
     *    alg : HS256
     *
     *  [Payload] : Three REGISTERED claims and One PRIVATE Claim are included
     *    iss : Naver
     *    sub : user
     *    exp : + 24h
     *
    ...
    /**
     *  If the jwt token was DIRTY,
     *  error will occur during the Jwts.parser() execution.
     *
     *  So with a Try-Catch statement, it can be determined to be able to use this token.
     */
    @Override
     ...
     *
     * @return Claims
     *  - Ex) {sub=User, iss=Naver, exp=1581669094, userId=1, email=test@gmail.com}
     */
    @Override
    public Claims get(){
