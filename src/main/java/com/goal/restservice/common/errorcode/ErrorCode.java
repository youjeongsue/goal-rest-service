...
public enum ErrorCode {
  ...
  // Goal
  GOAL_DOES_NOT_EXIST(400, "M006", "goal does not exist"),
  GOAL_CREATE_FAIL(400, "M007", "Creating goal failed"),
  SUBGOAL_CREATE_FAIL(400, "M008", "Creating subgoal failed"),
  SUBGOAL_DOES_NOT_EXIST(400, "M009", "subgoal does not exist"),
  // Category
  CATEGORY_DOES_NOT_EXIST(400, "M010", "category does not exist"),
  ;
